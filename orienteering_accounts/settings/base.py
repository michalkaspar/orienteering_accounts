...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'orienteering_accounts.core.context_processors.current_version',
            ],
        },
    },
]
...
ORIS_EVENT_LIST_WINDOW_DAYS_AHEAD = 210
...
EMAIL_SKIP_REGISTRATION_NUMBERS = config('PROJECT_EMAIL_SKIP_REGISTRATION_NUMBERS', default='', cast=Csv())
